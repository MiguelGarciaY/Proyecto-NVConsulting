...
import idat.edu.pe.modelo.ProductoParaVender;
import idat.edu.pe.modelo.ProductoVendido;
import idat.edu.pe.modelo.Venta;
import idat.edu.pe.repositorio.ProductosRepository;
import idat.edu.pe.repositorio.ProductosVendidosRepository;
import idat.edu.pe.repositorio.VentasRepository;
...
public class VenderController {
    ...
    public String agregarAlCarrito(@ModelAttribute Producto producto, HttpServletRequest request, RedirectAttributes redirectAttrs) {
        ...
        if (productoBuscadoPorCodigo == null) {
            redirectAttrs
                    .addFlashAttribute("mensaje", "El curso con el código " + producto.getCodigo() + " no existe")
                    .addFlashAttribute("clase", "warning");
            return "redirect:/vender/";
        }
        if (productoBuscadoPorCodigo.sinExistencia()) {
            redirectAttrs
                    .addFlashAttribute("mensaje", "El curso está agotado")
                    .addFlashAttribute("clase", "warning");
            return "redirect:/vender/";
        }
